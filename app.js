...
document.getElementById("ticket").innerHTML = venta.articulos() 
document.getElementById("total").innerHTML = "Total: "+ venta.total() 
document.getElementById("id").innerHTML = "Id de Cliente: " + venta.id;
document.getElementById("email").innerHTML = "Email de Cliente: "+venta.email;
